    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 flex flex-col items-center px-6">
        ...
        <div id="how" className="mt-16 sm:mt-32 mb-12 sm:mb-20 max-w-4xl w-full animate-fade-in">
          ...
          <div className="grid sm:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <h4 className="font-semibold mb-2">{t("landing.howItWorks.step1Title")}</h4>
            ...
            <div className="text-center p-6">
              ...
              <h4 className="font-semibold mb-2">{t("landing.howItWorks.step2Title")}</h4>
              <p className="text-sm text-gray-500">
            ...
            <div className="text-center p-6">
              ...
              <h4 className="font-semibold mb-2">{t("landing.howItWorks.step3Title")}</h4>
              <p className="text-sm text-gray-500">
        ...
        <div className="w-full max-w-4xl mx-auto mb-12 sm:mb-20 text-center animate-fade-in px-2">
          ...
          <div className="mt-8">
            ...
            >
              {t("landing.social.cta")} <span className="group-hover:translate-x-1 transition-transform">&rarr;</span>
            </Link>
          </div>
        </div>
      </main>
      ...
      <section id="contact" className="bg-white border-t py-16 text-center">
        <div className="max-w-xl mx-auto px-6">
          <h3 className="text-2xl font-bold mb-2">{t("landing.contact.title")}</h3>
          <p className="text-gray-600 mb-8">{t("landing.contact.subtitle")}</p>
          ...
          <p className="text-xs text-gray-400 mt-6">{t("landing.contact.note")}</p>
        </div>
      </section>

      <footer className="border-t border-gray-200 px-6 py-8 text-center text-sm text-gray-400">
        <p className="mb-3">{t("landing.footer.tagline")}</p>
        <div className="flex flex-wrap justify-center gap-4 mb-4">
          <Link href="/mentions-legales" className="hover:text-accent transition-colors">{t("landing.footer.legal")}</Link>
          <Link href="/cgu" className="hover:text-accent transition-colors">{t("landing.footer.terms")}</Link>
          <Link href="/confidentialite" className="hover:text-accent transition-colors">{t("landing.footer.privacy")}</Link>
        </div>
