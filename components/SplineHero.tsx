...
export function SplineSceneBasic() {
  return (
    <Card className="w-full h-[300px] sm:h-[400px] md:h-[500px] bg-black/[0.96] relative overflow-hidden rounded-2xl border-0">
      ...
      <div className="flex h-full">
        <div className="flex-1 p-6 sm:p-8 md:p-12 relative z-10 flex flex-col justify-center">
          ...
          <p className="mt-3 sm:mt-4 text-sm sm:text-base text-neutral-300 max-w-lg leading-relaxed">
